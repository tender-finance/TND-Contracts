...
describe("RewardRouterV2", function () {
  ...
  beforeEach(async () => {
    ...
    await tndVester.setGov(timelock.address)

    await rewardManager.updateEsTndHandlers()
  ...
  it("inits", async () => {
    ...
    expect(await rewardManager.stakedTndTracker()).eq(stakedTndTracker.address)
    expect(await rewardManager.bonusTndTracker()).eq(bonusTndTracker.address)
    expect(await rewardManager.feeTndTracker()).eq(feeTndTracker.address)
    expect(await rewardManager.stakedTndTracker()).eq(stakedTndTracker.address)
    expect(await rewardManager.stakedTndDistributor()).eq(stakedTndDistributor.address)
    expect(await rewardManager.esTnd()).eq(esTnd.address)
    expect(await rewardManager.bnTnd()).eq(bnTnd.address)
    expect(await rewardManager.tndVester()).eq(tndVester.address)
  ...
  it("stakeTndForAccount, stakeTnd, stakeEsTnd, unstakeTnd, unstakeEsTnd, claimEsTnd, claimFees, compound, batchCompoundForAccounts", async () => {
    ...
    await rewardRouter.connect(user1).unstakeEsTnd(esGmxUnstakeBalance1)
  ...
  //   expect(await tndVester.getPairAmount(user3.address, expandDecimals(992, 18))).gt(expandDecimals(199, 18))
  //   expect(await tndVester.getPairAmount(user3.address, expandDecimals(992, 18))).lt(expandDecimals(200, 18))
  //   expect(await tndVester.getPairAmount(user1.address, expandDecimals(892, 18))).gt(expandDecimals(199, 18))
  //   expect(await tndVester.getPairAmount(user1.address, expandDecimals(892, 18))).lt(expandDecimals(200, 18))
  //
  //   await rewardRouter.connect(user1).compound()
  //
  //   await expect(rewardRouter.connect(user3).acceptTransfer(user1.address))
  ...
  //
  //   expect(await tndVester.getCombinedAverageStakedAmount(user1.address)).gt(expandDecimals(1092, 18))
  //   expect(await tndVester.getCombinedAverageStakedAmount(user1.address)).lt(expandDecimals(1094, 18))
  //   expect(await tndVester.getCombinedAverageStakedAmount(user3.address)).gt(expandDecimals(1092, 18))
  //   expect(await tndVester.getCombinedAverageStakedAmount(user3.address)).lt(expandDecimals(1094, 18))
  //
  //   expect(await tndVester.getMaxVestableAmount(user2.address)).eq(0)
  //   expect(await tndVester.getMaxVestableAmount(user3.address)).gt(expandDecimals(1885, 18))
  //   expect(await tndVester.getMaxVestableAmount(user3.address)).lt(expandDecimals(1887, 18))
  //   expect(await tndVester.getMaxVestableAmount(user1.address)).gt(expandDecimals(1785, 18))
  //   expect(await tndVester.getMaxVestableAmount(user1.address)).lt(expandDecimals(1787, 18))
  //
  //   expect(await tndVester.getPairAmount(user2.address, expandDecimals(992, 18))).eq(0)
  //   expect(await tndVester.getPairAmount(user3.address, expandDecimals(1885, 18))).gt(expandDecimals(1092, 18))
  //   expect(await tndVester.getPairAmount(user3.address, expandDecimals(1885, 18))).lt(expandDecimals(1094, 18))
  //   expect(await tndVester.getPairAmount(user1.address, expandDecimals(1785, 18))).gt(expandDecimals(1092, 18))
  //   expect(await tndVester.getPairAmount(user1.address, expandDecimals(1785, 18))).lt(expandDecimals(1094, 18))
  //
  //   await rewardRouter.connect(user1).compound()
  ...
  //
  //   await tndVester.connect(user1).deposit(expandDecimals(1785, 18))
  //
  ...
  //   expect(await tnd.balanceOf(user1.address)).eq(expandDecimals(200, 18))
  //
  //   await tndVester.connect(user1).withdraw()
  //
  ...
  //   expect(await tnd.balanceOf(user1.address)).lt(expandDecimals(206, 18))
  //
  //   await tndVester.connect(user1).deposit(expandDecimals(365 * 2, 18))
  //
  ...
  //
  //   expect(await tndVester.claimable(user1.address)).eq(0)
  //
  //   await increaseTime(provider, 48 * 60 * 60)
  //   await mineBlock(provider)
  //
  //   expect(await tndVester.claimable(user1.address)).gt("3900000000000000000") // 3.9
  //   expect(await tndVester.claimable(user1.address)).lt("4100000000000000000") // 4.1
  //
  ...
  //   await mineBlock(provider)
  //
  //   expect(await tndVester.claimable(user1.address)).gt("9900000000000000000") // 9.9
  //   expect(await tndVester.claimable(user1.address)).lt("10100000000000000000") // 10.1
  //
  //   expect(await tnd.balanceOf(user1.address)).gt(expandDecimals(204, 18))
  //   expect(await tnd.balanceOf(user1.address)).lt(expandDecimals(206, 18))
  //
  //   await tndVester.connect(user1).claim()
  //
  ...
  //
  //   await tndVester.connect(user1).deposit(expandDecimals(365, 18))
  //   expect(await tndVester.balanceOf(user1.address)).gt(expandDecimals(1449, 18)) // 365 * 4 => 1460, 1460 - 10 => 1450
  //   expect(await tndVester.balanceOf(user1.address)).lt(expandDecimals(1451, 18))
  //   expect(await tndVester.getVestedAmount(user1.address)).eq(expandDecimals(1460, 18))
  //
  ...
  //   await mineBlock(provider)
  //
  //   expect(await tndVester.claimable(user1.address)).gt("7900000000000000000") // 7.9
  //   expect(await tndVester.claimable(user1.address)).lt("8100000000000000000") // 8.1
  //
  //   await tndVester.connect(user1).withdraw()
  //
  //   expect(await feeTndTracker.balanceOf(user1.address)).gt(expandDecimals(1190, 18))
  ...
  //   await mineBlock(provider)
  //
  //   expect(await tndVester.claimable(user1.address)).eq(expandDecimals(365, 18))
  //
  //   await tndVester.connect(user1).withdraw()
  //
  ...
  //
  //   expect(await tndVester.transferredAverageStakedAmounts(user2.address)).eq(0)
  //   expect(await tndVester.transferredAverageStakedAmounts(user3.address)).eq(expandDecimals(200, 18))
  ...
  //   expect(await tndVester.getCombinedAverageStakedAmount(user2.address)).eq(expandDecimals(200, 18))
  //   expect(await tndVester.getCombinedAverageStakedAmount(user3.address)).gt(expandDecimals(1092, 18))
  //   expect(await tndVester.getCombinedAverageStakedAmount(user3.address)).lt(expandDecimals(1093, 18))
  //   expect(await tndVester.getMaxVestableAmount(user2.address)).eq(0)
  //   expect(await tndVester.getMaxVestableAmount(user3.address)).gt(expandDecimals(1884, 18))
  //   expect(await tndVester.getMaxVestableAmount(user3.address)).lt(expandDecimals(1886, 18))
  //   expect(await tndVester.getPairAmount(user2.address, expandDecimals(992, 18))).eq(0)
  //   expect(await tndVester.getPairAmount(user3.address, expandDecimals(992, 18))).gt(expandDecimals(574, 18))
  //   expect(await tndVester.getPairAmount(user3.address, expandDecimals(992, 18))).lt(expandDecimals(575, 18))
  //   expect(await tndVester.getPairAmount(user1.address, expandDecimals(892, 18))).gt(expandDecimals(545, 18))
  //   expect(await tndVester.getPairAmount(user1.address, expandDecimals(892, 18))).lt(expandDecimals(546, 18))
  //
  ...
  //   await timelock.signalSetHandler(tndVester.address, esGmxBatchSender.address, true)
  ...
  //   await timelock.setHandler(tndVester.address, esGmxBatchSender.address, true)
  ...
  //   )
  //
  //   expect(await tndVester.transferredAverageStakedAmounts(user2.address)).gt(expandDecimals(37648, 18))
  //   expect(await tndVester.transferredAverageStakedAmounts(user2.address)).lt(expandDecimals(37649, 18))
  //   expect(await tndVester.transferredAverageStakedAmounts(user3.address)).gt(expandDecimals(12810, 18))
  //   expect(await tndVester.transferredAverageStakedAmounts(user3.address)).lt(expandDecimals(12811, 18))
  //   expect(await tndVester.transferredCumulativeRewards(user2.address)).eq(expandDecimals(100, 18))
  //   expect(await tndVester.transferredCumulativeRewards(user3.address)).gt(expandDecimals(892 + 200, 18))
  //   expect(await tndVester.transferredCumulativeRewards(user3.address)).lt(expandDecimals(893 + 200, 18))
  //   expect(await tndVester.bonusRewards(user2.address)).eq(0)
  //   expect(await tndVester.bonusRewards(user3.address)).eq(expandDecimals(100, 18))
  //   expect(await tndVester.getCombinedAverageStakedAmount(user2.address)).gt(expandDecimals(3971, 18))
  //   expect(await tndVester.getCombinedAverageStakedAmount(user2.address)).lt(expandDecimals(3972, 18))
  //   expect(await tndVester.getCombinedAverageStakedAmount(user3.address)).gt(expandDecimals(7943, 18))
  //   expect(await tndVester.getCombinedAverageStakedAmount(user3.address)).lt(expandDecimals(7944, 18))
  //   expect(await tndVester.getMaxVestableAmount(user2.address)).eq(expandDecimals(100, 18))
  //   expect(await tndVester.getMaxVestableAmount(user3.address)).gt(expandDecimals(1884 + 200, 18))
  //   expect(await tndVester.getMaxVestableAmount(user3.address)).lt(expandDecimals(1886 + 200, 18))
  //   expect(await tndVester.getPairAmount(user2.address, expandDecimals(100, 18))).gt(expandDecimals(3971, 18))
  //   expect(await tndVester.getPairAmount(user2.address, expandDecimals(100, 18))).lt(expandDecimals(3972, 18))
  //   expect(await tndVester.getPairAmount(user3.address, expandDecimals(1884 + 200, 18))).gt(expandDecimals(7936, 18))
  //   expect(await tndVester.getPairAmount(user3.address, expandDecimals(1884 + 200, 18))).lt(expandDecimals(7937, 18))
  //
  ...
  it("handleRewards", async () => {
    ...
    await timelock.signalSetGov(tndVester.address, timelockV2.address)
    ...
    await timelock.setGov(tndVester.address, timelockV2.address)

    await rewardManagerV2.updateEsTndHandlers()
    ...
    expect(await tnd.balanceOf(user1.address)).eq(expandDecimals(200, 18))
    await tnd.connect(user1).approve(stakedTndTracker.address, expandDecimals(200, 18))
    await rewardRouterV2.connect(user1).stakeTnd(expandDecimals(200, 18))
    expect(await tnd.balanceOf(user1.address)).eq(0)

    await increaseTime(provider, 24 * 60 * 60 * 2)
    await mineBlock(provider)
    ...
    expect(await feeTndTracker.depositBalances(user1.address, bnTnd.address)).gt((540000000000000000*2).toString()) // 0.54
    expect(await feeTndTracker.depositBalances(user1.address, bnTnd.address)).lt((560000000000000000*2).toString()) // 0.56
    ...
    expect(await ethBalance1.sub(ethBalance0)).lt(expandDecimals(8, 18))
    expect(await tnd.balanceOf(user1.address)).eq(0)
    expect(await esTnd.balanceOf(user1.address)).gt(expandDecimals(3571 - 365 * 1, 18))
    expect(await esTnd.balanceOf(user1.address)).lt(expandDecimals(3572 - 365 * 1, 18))
    expect(await bnTnd.balanceOf(user1.address)).eq(0)
//    expect(await glp.balanceOf(user1.address)).eq(0)
    expect(await eth.balanceOf(user1.address)).gt(expandDecimals(7, 18))
    expect(await eth.balanceOf(user1.address)).lt(expandDecimals(8, 18))
